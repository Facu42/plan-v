...
export function ShowroomConsultations({ patient, patients = [], now, onSelect, onChanged = () => undefined }: {
  ...
  const save = async () => {
    ...
    } catch { setError('No pudimos guardar la consulta. Revisá que el enlace sea HTTPS.'); }
