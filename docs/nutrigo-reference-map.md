...
| Progress (`105:2790`) | Superficie paciente Nutrigo operativa con adherencia, objetivo publicado, agua, sueño, energía, comidas revisadas y detalle seguro de siete días | Faltan comparación profesional por períodos y modelo autorizado de peso/medidas. Sin mediciones/fuentes no rellenar esos widgets; fotografías requieren decisión separada |
